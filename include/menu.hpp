...
private:
    ...
    void displayPlayerColor(int player_number, player_color_options selected_option);
    std::set<player_color_options> taken_colors;
...
public:
    ...
    std::string askPlayerColor(int player_number, player_color_options selected_option);
};
